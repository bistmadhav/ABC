...
const studentColors = ['#A52A2A', '#808000', '#357EC7', '#E6A9EC'];
...
export const StudentCategories = [
  { type: '1st Year loan', amount: 0, color: expenseColors[0] },
  { type: '2nd Year loan', amount: 0, color: expenseColors[1] },
  { type: '3rd Year loan', amount: 0, color: expenseColors[2] },
  { type: '4th Year loan', amount: 0, color: expenseColors[3] },
